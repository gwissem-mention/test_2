Feature:
    ...
    Scenario: Submit the facts form as a corporation legal not logged in with France Connect
        ...
        And the "identity_corporation_siren" field should contain "123456789"
        And the "identity_corporation_name" field should contain "Mon entreprise"
        And the "identity_corporation_function" field should contain "Directeur"
        And the "identity_corporation_nationality" field should contain "1"
