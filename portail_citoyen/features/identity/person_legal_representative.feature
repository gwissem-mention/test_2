Feature:
    ...
    Scenario: Submit the form with minimal valid values for person legal representative declarant
        ...
        And I select "Paris (75)" from "identity_representedPersonCivilState_birthLocation_town"
        ...
        And I select "Paris (75)" from "identity_representedPersonContactInformation_addressLocation_town"
        And I wait for the "#identity_representedPersonContactInformation_addressLocation_department" field to contain "75"
        And I fill in "identity_representedPersonContactInformation_addressNumber" with "01"
        And I select "1" from "identity_representedPersonContactInformation_addressWay"
        ...
        And I press "Suivant"
        Then I should be on "/faits" by js
    ...
    Scenario: Submit the form without any required values
        Given I am on "/identite"
        And I press "Suivant"
        Then I should be on "/identite" by js
