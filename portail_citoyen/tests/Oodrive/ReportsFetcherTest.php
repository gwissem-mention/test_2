...
class ReportsFetcherTest extends TestCase
{
    public function testFetchFoundReports(): void
    {
        ...
        $mockOodrive
            ->expects($this->once())
            ->method('getFolder')
            ->willReturn(new Folder(['id' => 'kxP5HZEXlGI', 'name' => '649b11d9f266e', 'parentId' => 'XeCnU6awkHc']));
        ...
        $mockOodrive
            ...
            ->willReturnOnConsecutiveCalls(
                [
                    new Folder(['id' => 'I1L3LTGTjps', 'name' => '67198d2a-1509-11ee-bab0-5b472fc01b43', 'parentId' => '75gVIUofzDA']),
                    new Folder(['id' => 'GvT36KDZknI', 'name' => '67198d2a-1509-11ee-bab0-5b472fc01b44', 'parentId' => '75gVIUofzDA']),
                ],
                [
                    new Folder(['id' => '-40wbGIH_7I', 'name' => 'PV', 'parentId' => 'I1L3LTGTjps']),
                ],
                [
                    new Folder(['id' => 'jpaWBwgWE9k', 'name' => 'PV', 'parentId' => 'GvT36KDZknI']),
                ]
            );
        ...
        $mockOodrive
            ...
            ->willReturnOnConsecutiveCalls(
                [
                    new File(['id' => 'slwS30-lxUE', 'name' => 'test.pdf']),
                    new File(['id' => 'X_LIEqrTLuk', 'name' => 'test.jpg']),
                ],
                [
                    new File(['id' => 'slwS30-lxUA', 'name' => 'test.pdf']),
                ],
            );
