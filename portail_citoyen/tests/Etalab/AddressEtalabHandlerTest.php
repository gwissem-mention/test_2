...
class AddressEtalabHandlerTest extends TestCase
{
    ...
    public function testSearchFeatures(): void
    {
        ...
        $addressEtalabHandler = new AddressEtalabHandler($httpClient);

        $responseData = $addressEtalabHandler->getSearchFeatures(
        ...
        self::assertSame($this->expectedResponseData['features'], $responseData);
    }
    ...
    public function testAddressModelIsEtalab(): void
    {
        ...
        $responseData = $addressEtalabHandler->getAddressModel(
    ...
    public function testIdIsFound(): void
    {
        ...
        $response = $httpClient->request('GET', '/search/', [
            'query' => $this->expectedRequestData,
        ]);
        $addressEtalabHandler = new AddressEtalabHandler($httpClient);

        $responseData = $addressEtalabHandler->findOneById('80021_6590_00008', $response->toArray()['features']);
        self::assertInstanceOf(AddressEtalabModel::class, $responseData);
        self::assertSame('80021_6590_00008', $responseData->getId());
    }
    ...
    public function testIdIsNotFound(): void
    {
        ...
        $responseData = $addressEtalabHandler->findOneById('80021_6590_00059', $response->toArray()['features']);
