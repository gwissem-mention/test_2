Feature:
    ...
    @func
    Scenario: I can access the complaint's objects facts page if the complaint is assigned to my unit, but I can't access a complaint assigned to another unit
        Given I am on "/plainte/objets/91"
        And the response status code should be 200
        Then I am on "/plainte/objets/1"
        And the response status code should be 403

    @func
    Scenario: I can access the complaint's objects facts page if the complaint is assigned to me, but I can't access other complaints
        Given I am authenticated with PR5KTQSD from GN
        And I am on "/plainte/objets/101"
        And the response status code should be 200
        Then I am on "/plainte/objets/91"
        And the response status code should be 403
...
#        And the "administrative_document_thiefFromVehicle" field should contain "Non"
    ...
    Scenario: I can click on the Go to facts button
        ...
        And I should be on "/plainte/informations-complementaires/91"
        And the response status code should be 200
