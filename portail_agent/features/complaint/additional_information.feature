Feature:
    ...
    @func
    Scenario: I can access the complaint's additional information page if the complaint is assigned to my unit, but I can't access a complaint assigned to another unit
        Given I am on "/plainte/informations-complementaires/91"
        And the response status code should be 200
        Then I am on "/plainte/informations-complementaires/1"
        And the response status code should be 403

    @func
    Scenario: I can access the complaint's additional information page if the complaint is assigned to me, but I can't access other complaints
        Given I am authenticated with PR5KTQSD from GN
        And I am on "/plainte/informations-complementaires/101"
        And the response status code should be 200
        Then I am on "/plainte/informations-complementaires/91"
        And the response status code should be 403
