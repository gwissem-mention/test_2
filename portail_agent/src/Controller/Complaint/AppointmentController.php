...
class AppointmentController extends AbstractController
{
    ...
    #[Route(path: '/plainte/rendez-vous/{id}', name: 'complaint_appointment', methods: ['GET', 'POST'])]
    public function __invoke(Complaint $complaint, Request $request): Response
    {
        $this->denyAccessUnlessGranted('COMPLAINT_VIEW', $complaint);

        // TODO : Modify this with the real form validation
