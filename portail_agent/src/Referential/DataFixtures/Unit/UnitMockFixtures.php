...
class UnitMockFixtures extends Fixture implements FixtureGroupInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        $units = [
            new Unit(
                'bta.villegouge@gendarmerie.interieur.gouv.fr',
            ...
            new Unit(
                'bta.biganos@gendarmerie.interieur.gouv.fr',
                'corg.ggd33@gendarmerie.interieur.gouv.fr',
                '1401',
                '7035',
            ...
            new Unit(
                'ddsp33-csub-le-bouscat-ppel@interieur.gouv.fr',
                'ddsp33-ppel@interieur.gouv.fr',
                '102765',
                '102765',
            ...
            new Unit(
                'ddsp33-csp-bordeaux-ppel@interieur.gouv.fr',
                'ddsp33-ppel@interieur.gouv.fr',
                '74097',
                '74097',
