...
class UnitMockFixtures extends Fixture implements FixtureGroupInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        $units = [
            new Unit(
                'cob.renage@gendarmerie.interieur.gouv.fr',
                'corg.ggd38@gendarmerie.interieur.gouv.fr',
                '3002739',
                '2739',
            ...
            new Unit(
                'ddsp31-csp-toulouse-ppel@interieur.gouv.fr',
                'ddsp31-ppel@interieur.gouv.fr',
                '72903',
                '72903',
