...
class OodriveCleanUpDeclarationCronTest extends KernelTestCase
{
    public function test(): void
    {
        ...
        $command = $application->find('app:cron:oodrive:clean-up:declaration');
        ...
        $this->assertStringContainsString('180 complaints cleaned up.', $output);
