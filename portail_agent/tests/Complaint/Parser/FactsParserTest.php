        ...
        $factsContent = json_decode('
{
	...
	"website": null
        ...
        $this->assertEquals('France', $facts->getStartAddressCountry());
        $this->assertEquals('80', $facts->getStartAddressDepartment());
        $this->assertEquals(80, $facts->getStartAddressDepartmentNumber());
        ...
        $this->assertEquals('Amiens', $facts->getEndAddressCity());
        $this->assertEquals('80000', $facts->getEndAddressPostalCode());
        $this->assertEquals('80021', $facts->getEndAddressInseeCode());
    }
        ...
        $factsContent = json_decode('
{
	...
	"callingPhone": null
        ...
        $this->assertEquals('Description', $facts->getDescription());
        $this->assertEquals('France', $facts->getStartAddressCountry());
        $this->assertEmpty($facts->getStartAddressDepartment());
        $this->assertEquals(0, $facts->getStartAddressDepartmentNumber());
        $this->assertEquals('RESTAURANT', $facts->getPlace());
        ...
        $this->assertNull($facts->getEndAddressCity());
        $this->assertNull($facts->getEndAddressPostalCode());
        $this->assertNull($facts->getEndAddressInseeCode());
    }

    public function testParsePhoneNaturePlace(): void
    {
        $parser = $this->getParser();
        ...
        $factsContent = json_decode('
{
	...
	"placeNature": "RESEAU TELEPHONIQUE",
	"victimOfViolence": true,
	"victimOfViolenceText": "Violence text",
	"description": "Description",
	"callingPhone":
    {
        ...
        $this->assertEquals('80', $facts->getStartAddressDepartment());
        $this->assertEquals(80, $facts->getStartAddressDepartmentNumber());
        $this->assertEquals('RESEAU TELEPHONIQUE', $facts->getPlace());
        $this->assertEquals('Amiens', $facts->getStartAddressCity());
        $this->assertEquals('80000', $facts->getStartAddressPostalCode());
        $this->assertEquals('80021', $facts->getStartAddressInseeCode());
        $this->assertTrue($facts->isExactPlaceUnknown());
    ...
    public function testParseInternetNaturePlace(): void
    {
        $parser = $this->getParser();
        ...
        $factsContent = json_decode('
{
	...
	"website": "www.google.com"
        ...
        $this->assertEquals('80', $facts->getStartAddressDepartment());
        $this->assertEquals(80, $facts->getStartAddressDepartmentNumber());
        $this->assertEquals('INTERNET', $facts->getPlace());
        $this->assertEquals('Amiens', $facts->getStartAddressCity());
        $this->assertEquals('80000', $facts->getStartAddressPostalCode());
        $this->assertEquals('80021', $facts->getStartAddressInseeCode());
        $this->assertTrue($facts->isExactPlaceUnknown());
